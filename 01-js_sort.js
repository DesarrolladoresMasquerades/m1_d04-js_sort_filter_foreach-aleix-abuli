...
// Rules are that TWO elements will be given to your function and your function MUST return -1, 0 or 1 according to wether el1 is smaller or greater than el2
...
console.log("sortedNumbers return: ", sortedNumbers);
...
function sortStudentsByAgeQuick(student1, student2){
    return parseInt(student1.age) - parseInt(student2.age); // parse turns everything into a number so you make sure that if somebody enters a string it works (????)
}
